...
<img decoding="async" src="./updrs.png" width="30%">
...
<img decoding="async" src="./openpose_result.png" width="30%">
每個位置則分別代表身體上的不同部位
...
<img decoding="async" src="./ques.png" width="50%">
...
<img decoding="async" src="./data_parse1.png" width="50%"> <img decoding="async" src="./data_parse2.png" width="50%">
...
<img decoding="async" src="./hint_model_L/L_loss_surface.png" width="50%"> <img decoding="async" src="./hint_model_R/R_loss_surface.png" width="50%">
